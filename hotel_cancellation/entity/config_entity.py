...
class DataIngestionConfig:
    ...
    feature_ingestion_file_path:str=os.path.join(data_ingestion_dir,DATA_INGESTION_FEATURE_STORE_DIR,FILE_NAME)
...
class ModelTrainerConfig:
    ...
    trained_model_file_path:str=os.path.join(model_trainer_dir,MODEL_TRAINER_DIR_NAME)
    accepted_accuracy:float=MODEL_TRAINER_EXCPECTED_SCORE
